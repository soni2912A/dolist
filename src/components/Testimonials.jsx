...
function Testimonial() {
  return (
    <section className="bg-white py-20 px-6 layout">
      {/* HEADING */}
      ...
      {/* CONTENT */}
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-9">
        {/* LEFT TEXT BOX */}
        {/* LEFT TESTIMONIAL BOX */}
        <div className="relative">
          {/* RED FRAME */}
          <div className="absolute pointer-events-none w-[380px] h-[500px]">
            <span className="absolute top-0 left-2 w-104 h-3 bg-[#ff4d5a]" />
            <span className="absolute top-0 left-2 w-3 h-full bg-[#ff4d5a]" />
            <span className="absolute top-0 right-2 w-3 h-full bg-[#ff4d5a]" />
            <span className="absolute bottom-0 left-2 w-104 h-3 bg-[#ff4d5a]" />
          </div>

          {/* WHITE BOX */}
          <div className="relative bg-white p-8 md:p-12 ml-15 mt-20 mb-9">
            ...
            <div className="mt-8 flex items-start gap-0  pr-2">
              ...
              {/* TEXT */}
              <div>
                <p className="font-bold text-gray-900 pl-3 mt-0 mb-2">
                  Sherri Cronin
                </p>
                <p className="text-sm text-gray-500 pl-3 mb-4">
